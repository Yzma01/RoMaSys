...
export const ClientAction = ({ logo: Logo, onClick, className = '', freeze }) => {
  ...
  return (
    <button 
      onClick={onClick}
      className={`w-10 h-10 rounded-full bg-black border-none font-semibold flex items-center justify-center shadow-md cursor-pointer transition-all duration-300 overflow-hidden relative text-decoration-none hover:w-30 hover:rounded-lg ${className} ${freeze?"bg-[#367cff]":""}`}
    >
