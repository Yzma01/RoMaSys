      ...
      {monthlyType.map(({ type }, index) => (
        ...
        >
          <input
            ...
            />
          <div
            className={`absolute w-full h-full rounded-lg transition-all duration-300 ease-in-out 
              bg-transparent border-2 border-transparent 
              hover:bg-[rgba(66,153,225,0.5)] 
              ${
                value === type
                  ? "bg-[rgba(66,153,225,0.5)] border-blue-500"
                  : ""
              }
            `}
          ></div>
          <div
            className={`absolute w-4 h-4 rounded-full bg-blue-500 transition-all duration-200 
